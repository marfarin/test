...
use common\models\rbacDB\AbstractItem;
use common\components\GhostAccessControl;
use webvimark\components\AdminDefaultController;
use common\models\rbacDB\search\PermissionSearch;
...
class PermissionController extends AdminDefaultController
{
     ...
     * @var Permission
     */
    public $modelClass = 'common\models\rbacDB\Permission';

    /**
     * @var PermissionSearch
     */
    public $modelSearchClass = 'common\models\rbacDB\search\PermissionSearch';
    ...
    public function actionSetChildRoutes($id)
    {
        ...
        if (($toAdd || $toRemove) && ($id == ConfigureRbac::getActualConfigureRbacInstance()->common_permission_name)) {
